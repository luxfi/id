...
import {HanzoAppQrCode, HanzoAppUrl} from "../common/HanzoAppConnector";
        ...
        title={() => (
          <div>
            ...
            <Popover
              ...
              content={<HanzoAppQrCode accessToken={this.props.accessToken} icon={this.state.icon} />}
            >
            ...
            <Popover
              trigger="click"
              content={<HanzoAppUrl accessToken={this.props.accessToken} />}
            >
